...
/* ./.libs/lt-ahost.c - temporary wrapper executable for .libs/ahost.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-0.1

   The ahost program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ahost.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ahost - temporary wrapper script for .libs/ahost.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-0.1\n", f);
  fputs ("#\n", f);
  fputs ("# The ahost program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ahost.exe:ahost:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian-2", f);
  fputs (".4.6-0.1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ahost.exe:ahost:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ahost.exe:ahost:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
