...
/* ./.libs/lt-acountry.c - temporary wrapper executable for .libs/acountry.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-0.1

   The acountry program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "f:\\Git\\exosip-win\\OSIP_MT\\c-ares\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "f;C:\\msys\\1.0\\Git\\exosip-win\\OSIP_MT\\c-ares\\.libs;C:\\msys\\1.0\\local\\lib;C:\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "acountry.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# acountry - temporary wrapper script for .libs/acountry.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-0.1\n", f);
  fputs ("#\n", f);
  fputs ("# The acountry program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ./libcares.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"acountry.exe:acountry:$LINENO: libtool wrapper (GNU libtool) 2.4.6 De", f);
  fputs ("bian-2.4.6-0.1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"acountry.exe:acountry:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"acountry.exe:acountry:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=f:/Git/exosip-win/OSIP_MT/c-ares/.libs:/usr/local/lib:/usr/local/bin:$", f);
  fputs ("PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"f:/Git/exosip-win/OSIP_MT/c-ares/.libs:$PATH\"\n", f);
  fputs ("\n", f);
