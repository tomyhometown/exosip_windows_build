...
/* ./.libs/lt-adig.c - temporary wrapper executable for .libs/adig.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-0.1

   The adig program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "adig.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# adig - temporary wrapper script for .libs/adig.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-0.1\n", f);
  fputs ("#\n", f);
  fputs ("# The adig program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"adig.exe:adig:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian-2.4", f);
  fputs (".6-0.1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"adig.exe:adig:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"adig.exe:adig:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
